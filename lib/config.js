...
const PAGE_PROFILES = {
  ...
  proofread: {
    name: 'proofread',
    targetUrlFragment: process.env.REVIEW_PROOFREAD_TARGET_URL_FRAGMENT || 'review.newidea.pro/proofread',
    bridgePath: path.join(__dirname, '..', 'proofread-bridge.js'),
    bridgeGlobal: '__jse_proofread__',
    routeLabel: '/proofread',
  },
};
